  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({ username: "", email: "", password: "", confirmPassword: "", group_name: "" }); // Reset form
        setError("");
        router.replace("/authentication/login"); // Redirect to login page after successful registration
      } else {
        const errorData = await response.json();
        setError(errorData.group_name || "Failed to register user.");
      }
    } catch (err) {
